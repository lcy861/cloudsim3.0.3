...
import org.cloudbus.cloudsim.util.SortListUtil;
...
public abstract class PowerVmAllocationPolicyAbstract extends VmAllocationPolicy {
	...
	public boolean allocateHostForVm(Vm vm) {
		return allocateHostForVm(vm, findHostForVmBF(vm));
	}
	...
	public PowerHost findHostForVmBF(Vm vm) {
		List<PowerHost> hostList = this.<PowerHost> getHostList();
		SortListUtil.sortByAvailableMips(hostList);
		return findHostForVm(vm);
	}
